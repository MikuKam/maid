                ...
                if (spineActions) {
                    spineActions.forEach(function(spineAction) {
                        ...
                        // set mix
                            ...
                            this._MSS_Spine.stateData.setMix(spineAction.from, spineAction.to, spineAction.duration);
                            picture._MSS_SpineMixList[[spineAction.from, spineAction.to]] = spineAction;
                        // set skin
